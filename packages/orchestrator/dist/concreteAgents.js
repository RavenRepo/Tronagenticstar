...
import { createLLMManager, AGENT_CONFIGS, PROMPT_TEMPLATES, } from "@constella/llm-core";
/**
...
Respond in structured JSON format with analysis, components, recommendations, complexity_score (1-10), and maintainability rating.`,
            ...
            return {
                analysis: "Unable to perform AI analysis. Please check API configuration.",
    ...
    `.trim();
        try {
            const response = await this.llmManager.completion([
                {
                    role: "system",
                    content: "You are an expert system architect who creates comprehensive C4 diagrams. Generate detailed C4 model descriptions including Context, Container, Component, and Code levels.",
                },
                {
                    role: "user",
...
Format as structured JSON with context_diagram, container_diagram, component_diagram, code_diagram fields.`,
            ...
            return {
                context_diagram: c4Model.context_diagram ||
                    "System context with external dependencies and users",
                container_diagram: c4Model.container_diagram ||
                    "High-level containers and technology choices",
                component_diagram: c4Model.component_diagram ||
                    "Component relationships within containers",
                code_diagram: c4Model.code_diagram ||
            ...
            return {
                context_diagram: "C4 model generation unavailable - check LLM configuration",
    ...
    `.trim();
        try {
            const response = await this.llmManager.completion([
                {
                    role: "system",
                    content: "You are a senior architect expert in design patterns. Analyze systems and suggest appropriate patterns while identifying anti-patterns.",
                },
                {
                    role: "user",
...
Format as JSON with scan_results (severity counts), vulnerabilities array (type, severity, location, recommendation), and compliance_score.`,
                ...
                vulnerabilities: securityAnalysis.vulnerabilities || [
                    {
                        ...
                        recommendation: "Implement comprehensive security scanning with AI analysis",
                    },
                ],
                ...
                vulnerabilities: [
                    {
                        ...
                        recommendation: "Configure OpenAI API key for AI-powered security analysis",
                    },
                ],
    ...
    async assessVulnerabilities(params) {
